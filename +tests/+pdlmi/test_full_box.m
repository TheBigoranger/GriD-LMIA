...
function testDefOrdThrConAnd(testCase)
...
function testExpOrdAndMinVal(testCase)
...
function testSymMatGraDimRem(testCase)
...
function testZerOrdAxiOmiNeg(testCase)
