...
function testConForDefAndImm(testCase)
...
function testCanDirAndFulBox(testCase)
    P = pdvar(1, {[0 1]}, Degree=4);
    direct = P >= 0;
...
function testWidOrdAndConVal(testCase)
    P = pdvar(1, {[0 1]}, Degree=4);
    direct = P >= 0;
...
function testAppRebAndRepEve(testCase)
    P = pdvar(1, {[0 1]}, Degree=4);
    direct = P >= 0;
...
function testUniTriAndPenCli(testCase)
...
function testAsyTenWinInc(testCase)
...
function testAniWinAndDenEnd(testCase)
...
function testMatEntCelAndRat(testCase)
