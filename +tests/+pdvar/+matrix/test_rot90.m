function tests = test_rot90
    % Public pdvar.rot90 behavioral contracts.
    tests = functiontests(localfunctions);
end

function test_tensor_negative_rotation_mixed(testCase)
