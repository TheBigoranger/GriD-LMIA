function tests = test_reshape
    % Public pdvar.reshape behavioral contracts.
    tests = functiontests(localfunctions);
end

function test_tensor_inferred_row_reshape_mixed(testCase)
