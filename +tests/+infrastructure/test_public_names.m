function tests = test_public_names
    % Behavioral regressions for package public names.
...
function test_public_type_pd_name_pdbase_parent(testCase)
...
function test_breaking_rename_intentionally_provides_no(testCase)
...
function test_representative_failures_expose_renamed_public(testCase)
...
function test_breaking_replacements_exist_while_superseded_method(testCase)
