...
function testScalarStoredBoundsAndDynamicClass(testCase)
    ...
    verifyDerivativeState(testCase, D, [-2 3]);
end

function testTensorRateVertexOrder(testCase)
...
function testDegreeZeroAndExplicitBounds(testCase)
    ...
    verifyDerivativeState(testCase, D, [-1 2]);
end

function testInvalidBoundsAndRepeatedDerivative(testCase)
...
function verifyDerivativeState(testCase, D, rb)
