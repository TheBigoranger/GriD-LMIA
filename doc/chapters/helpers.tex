...
\section{\texorpdfstring{\code{helper.normalizeDegree}}{helper.normalizeDegree}}
...
\syntaxhead
\begin{lstlisting}[style=dpsyntax]
degree = helper.normalizeDegree(value, nPar, errId, label)
\end{lstlisting}
