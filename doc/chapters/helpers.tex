...
\section{\texorpdfstring{\codeplain{helper.cellGet}}{helper.cellGet}}

\textit{Purpose.} \code{helper.cellGet} reads one flat coefficient leaf from a nested physical-cell tree.
...
\section{\texorpdfstring{\codeplain{helper.chk}}{helper.chk}}
...
\section{\texorpdfstring{\codeplain{helper.combRows}}{helper.combRows}}
...
\section{\texorpdfstring{\codeplain{helper.isZero}}{helper.isZero}}
...
\section{\texorpdfstring{\codeplain{helper.mkGrid}}{helper.mkGrid}}
...
\section{\texorpdfstring{\codeplain{helper.mkNest}}{helper.mkNest}}
...
\section{\texorpdfstring{\codeplain{helper.normDeg}}{helper.normDeg}}
...
\subsection{\texorpdfstring{\codeplain{helper.chkCont}}{helper.chkCont}}
...
\subsection{\texorpdfstring{\codeplain{helper.fitVals}}{helper.fitVals}}
...
\subsection{\texorpdfstring{\codeplain{helper.normMode}}{helper.normMode}}
...
\subsection{\texorpdfstring{\codeplain{helper.rateVerts}}{helper.rateVerts}}
