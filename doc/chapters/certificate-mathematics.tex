...
For \(\ell\ge2\) and direction-wise absolute order \(\mathbf r\), use the already defined tensor Bernstein lift \(Z_{\mathbf a}=\mathbf b_{\mathbf a}\otimes I_n\). The implemented form is
\[
  S^{(\mathbf c)}=
