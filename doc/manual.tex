...
evaluation, algebra, matrix operations, indexing, assignment, and error
boundaries.
...
matrix slicing, and block assignment.
...
points, function-only coefficient algebra, incompatible matrix sizes, mixed
physical grid bounds, \code{cat} dimensions other than 1 or 2, deletion
assignment, matrix-growth assignment, and block assignments with incompatible
payload size.
...
\begin{itemize}[leftmargin=*]
  ...
  \item \code{dpmat} is a known-data object only.  It does not contain YALMIP
        decisions, rate dependence, exact function-handle algebra, plotting, or
        solver-facing LMI assembly.
