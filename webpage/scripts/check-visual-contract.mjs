...
check("flat lookup with direct single-symbol links", /ReferenceCategoryHub/.test(documentsHub) && !/reference-index__group/.test(referenceIndex) && /reference-index__family[\s\S]*open/.test(read("scripts/generate-reference-index.mjs")) && /reference-index__symbols/.test(read("scripts/generate-reference-index.mjs")) && /reference-index__direct-symbol/.test(read("scripts/generate-reference-index.mjs")) && /singleEntry/.test(read("scripts/generate-reference-index.mjs")));
