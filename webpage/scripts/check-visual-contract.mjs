...
check("v1.0.0 public metadata with retained minor history", /current:\s*"v1\.0\.0"/.test(versionData) && /Version 1\.0\.0/.test(pdlmiOverview) && (versionHistory.match(/version:\s*"v/g)?.length ?? 0) === 5 && ["v0.1.0", "v0.2.12", "v0.3.6", "v0.4.7", "v1.0.0"].every((version) => versionHistory.includes(`version: "${version}"`)) && ["63c06ee", "98b63e5", "fe74a65", "c6a2e25"].every((commit) => versionHistory.includes(commit)) && !["v0.2.0", "v0.3.0", "v0.3.5", "v0.4.1", "v0.4.2", "v0.4.3", "v0.4.4"].some((version) => versionHistory.includes(`version: "${version}"`)) && /version:\s*"v1\.0\.0"[\s\S]*date:\s*"2026-07-19"/.test(versionHistory) && /version:\s*"v0\.4\.7"[\s\S]*date:\s*"2026-07-18"[\s\S]*c6a2e25/.test(versionHistory));
