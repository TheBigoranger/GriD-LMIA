---
title: Thanks
description: Acknowledgements and reference influences for the DP-LMI manual website.
---
...
ROLmip, LPVTools, ROMULOC, MATLAB documentation, YALMIP examples, and TikZ-style manuals are useful reference points for documentation structure, examples, and notation. They are not runtime dependencies of the DP-LMI package unless a future implementation explicitly adds such an adapter.
