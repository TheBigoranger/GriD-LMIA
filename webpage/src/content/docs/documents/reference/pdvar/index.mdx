...
<nav class="manual-trail"><a href="/GriD-LMIA/documents/">Documents</a><span>/</span><a href="/GriD-LMIA/documents/reference-index/">Reference</a><span>/</span><span>pdvar</span></nav>
...
| Reference | Task |
| :--- | :--- |
| [`Storage and evaluation`](/GriD-LMIA/documents/reference/pdvar/storage-and-evaluation/) | Traverse symbolic and rate rows, elevate them independently, and evaluate the stored symbolic expressions directly. |
| [`rhodiff`](/GriD-LMIA/documents/reference/pdvar/rhodiff/) | Build rate-vertex derivatives with propagated continuity. |
...
`pdvar` represents expressions. Solver handoff begins with
[`pdlmi`](/GriD-LMIA/documents/reference/pdlmi/), followed by the caller's
solver choice and `optimize` call.
