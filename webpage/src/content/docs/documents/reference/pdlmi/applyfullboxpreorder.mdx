...
parameter box. It is distinct from the implemented
[`applyPutinar`](/PD-LMI-package/documents/reference/pdlmi/applyputinar/)
module because full box includes every generator-subset product. It is not a
general-domain SOS interface, a full-space SOS representation, or an automatic
hierarchy selector.
