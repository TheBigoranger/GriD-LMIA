...
export const certificateSources: CertificateSource[] = [
  ...
  },
  {
    ...
    label: "SparseFullBox",
    description: "SparseFullBox keeps every full-box parity or generator-mask family but replaces each dense Gram block by axis-aligned tensor windows. Bandwidth one canonicalizes to Direct; a width at least order + 1 canonicalizes to FullBox.",
