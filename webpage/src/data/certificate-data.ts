...
export const certificateSources: CertificateSource[] = [
  ...
  },
  {
    ...
    formula: [
      "w=1:\\;\\text{Direct}",
      "1<w<r+1:\\;\\text{band-limited Gram support}",
      "w\\ge r+1:\\;\\text{FullBox}",
    ],
    cardFormula: "\\begin{gathered}S^{(\\mathbf c)}=\\sum_{J}\\sum_{\\mathbf t}g_JS_{J,\\mathbf t}\\\\\\operatorname{supp}S_{J,\\mathbf t}\\subseteq\\prod_a\\{t_a,\\ldots,t_a+w-1\\}\\end{gathered}",
