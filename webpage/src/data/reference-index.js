...
export const referenceEntries = [
  {
    ...
    href: "/DP-LMI-package/documents/reference/pdbase/",
  },
  ...pdbaseMethods.map(([name, task]) => entry(name, "pdbase method", task, "documents/reference/pdbase/storage-inspection", `pdbase-${name}`)),
  {
    ...
    href: "/DP-LMI-package/documents/reference/pdmat/",
  },
  {
    name: "pdmat constructor",
    type: "pdmat function",
    task: "Create coefficient-backed or function-backed known-data matrices.",
    href: "/DP-LMI-package/documents/reference/pdmat/constructor/",
  },
  ...pdmatMethods.map(([name, task, dedicated]) => entry(name, "pdmat method", task, dedicated ? `documents/reference/pdmat/${dedicated.toLowerCase()}` : "documents/reference/pdmat/matrix-operations", dedicated ? "" : `pdmat-${name}`)),
  {
    ...
    href: "/DP-LMI-package/documents/reference/pdvar/",
  },
  {
    name: "pdvar constructor",
    type: "pdvar function",
    task: "Create symmetric or full continuous Bernstein decision variables.",
    href: "/DP-LMI-package/documents/reference/pdvar/constructor/",
  },
